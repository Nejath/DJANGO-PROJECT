...
def orderform(request):
    ...
    if(request.method=="POST"):
        ...
        if (ac.amount >= total):
            ...
            return render(request,'ordrdetails.html',{'msg':msg,'total':total})
        else:
            msg= "insufficiant Amount "
            return render(request, 'ordrdetails.html', {'msg': msg})
...
def orderview(request):
    ...
    return render(request,'ordeview.html',{'o':o,'name':u.username})
